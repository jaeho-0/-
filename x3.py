...
API_KEY = 'AIzaSyAJBPWvGmMmjgoA0wyLszGZPkjb5czjvI0'
CSE_ID = '47d92a81857544d97'
...
image_links = search_images_without_youtube("김치찌개", max_images=100)
save_images(image_links, folder_name="김치찌개_이미지")
